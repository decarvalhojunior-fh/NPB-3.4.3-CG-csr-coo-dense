...
void write_cg_csr_info(FILE *fp, char class);
void write_cg_coo_info(FILE *fp, char class);
void write_cg_dense_info(FILE *fp, char class);
...
enum benchmark_types {SP, BT, LU, MG, FT, IS, EP, CG_csr, CG_coo, CG_dense, UA, DC};
...
void get_info(char *argv[], int *typep, char *classp) 
{
  ...
  *classp = *argv[2];
  ...
  else if (!strcmp(argv[1], "cg_coo") || !strcmp(argv[1], "CG_coo")) *typep = CG_coo;
  else if (!strcmp(argv[1], "cg_csr") || !strcmp(argv[1], "CG_csr")) *typep = CG_csr;
  else if (!strcmp(argv[1], "cg_dense") || !strcmp(argv[1], "CG_dense")) *typep = CG_dense;
...
/*\n\
 ...
 case DC:
  ...
  case EP:	      
    ...
    break;	      
  case CG_coo:	      
    write_cg_coo_info(fp, class);
    break;
  case CG_csr:	      
    write_cg_csr_info(fp, class);
    break;
  case CG_dense:	      
    write_cg_dense_info(fp, class);
    break;
  case UA:	      
